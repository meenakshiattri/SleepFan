...
public class Fan3Activity extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MenuActivity.soundSelection=R.raw.fire_furnace_rumble_with_loop;
		...
		fanBlade = new GameView(Fan3Activity.this);
		...
		if(sound!=null && MenuActivity.onTouchFan3)
		{
			sound.play();
		}
	}
		...
		case R.id.stopbtn:
			...
			if (onTouchStopBtn) 
			{
				...
				if(onTouchZeroSet)
				{
					...
					onTouchSetTime=false;
					sound = null;
					sound = new SoundCrossFading(Fan3Activity.this);
					sound.load(R.raw.fire_furnace_rumble_with_loop, true);
					sound.play();
