...
public class Fan4Activity extends Activity implements OnClickListener 
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		MenuActivity.soundSelection=R.raw.oven_fan_with_loop;
		...
		fanBlade = new GameView(Fan4Activity.this);
		...
		if(sound!=null && MenuActivity.onTouchFan4)
		{
			sound.play();
		}
	}
		...
		case R.id.stopbtn:
			...
			if (onTouchStopBtn) 
			{
				...
				if(onTouchZeroSet)
				{
					...
					onTouchSetTime=false;
					sound = null;
					sound = new SoundCrossFading(Fan4Activity.this);
					sound.load(R.raw.oven_fan_with_loop, true);
					sound.play();
